...
class HomeRecyclerviewAdapter(private val homeDataSet: List<Restaurante>): RecyclerView.Adapter<HomeRecyclerviewAdapter.HomeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        holder.bind(homeDataSet[position])
    }
}